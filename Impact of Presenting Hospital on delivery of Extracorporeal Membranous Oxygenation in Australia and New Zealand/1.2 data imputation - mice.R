...
ecmo.pc.miss = ecmo.miss/ecmo.tot * 100 # 3.31%
...
hmi = how_many_imputations(glm.pilot,
                           cv = 0.05, alpha = 0.05) #15, therefore no need for full imputation

## NB: I had code written for full imputation, but this didn't become necessary (the pilot imputation was sufficient)
## and so it's been commented out
